...
/*   Updated: 2021/04/02 11:13:58 by salome           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
** Defining a proper int entry, it allows to not override our attributes, 
** and initialize from either side what is needed from Frag and Ninja */

NinjaTrap::NinjaTrap( int preset )
{
	preset = 0;
    std::cout << T_BB "NinjaTrap Diamond Constructor called" T_N << std::endl;
	this->_energyPoints = 120;
	this->_maxEnergyPoints = 120;
	this->_meleeAttackDamage = 60;
...
NinjaTrap::NinjaTrap( std::string const &name )
{
	...
	this->_name = name;
	std::cout << getName() <<  T_BB ", he's settling his attributes and wants to fight... _> " << std::endl;
	this->_hitPoints = 60;
	this->_maxHitPoints = 60;
	this->_energyPoints = 120;
	this->_maxEnergyPoints = 120;
